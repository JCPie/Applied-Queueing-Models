...
stations = ["0: ",  "1: SD", "2: Bb", "3: Bl", "4: Bf", "5: AGV", "6: ADBf", "7: A", "8: ABf", "9: D", "10: P", "11: Pa", "12: DBb", "13: DBl", "14: DBf"]
O = 0
SD = 1
Bb = 2
Bl = 3
...
servers = [1, 3, np.inf, np.inf, np.inf, 1, np.inf, 2, np.inf, np.inf, 2, 1, np.inf, np.inf, np.inf]
